...
基于最新的基准测试结果，tree-cli 在各个方面的性能表现如下：

### 文件系统读取性能
- **小目录**：17.539 µs - 18.399 µs
- **中目录**：20.328 µs - 20.525 µs
- **大目录**：23.847 µs - 24.094 µs

### 递归遍历性能
- **2层深度**：664.23 µs - 676.87 µs
- **3层深度**：2.0916 ms - 2.1230 ms
- **4层深度**：6.5176 ms - 6.5597 ms

### 字符串操作性能
- **符号前缀生成**：143.01 ns - 173.90 ns
- **路径字符串格式化**：69.554 ns - 70.403 ns

### 内存分配性能
- **创建文件列表**：42.286 µs - 42.455 µs
- **创建路径向量**：44.429 µs - 44.714 µs
